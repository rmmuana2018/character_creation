...
class _CreateScreenState extends State<CreateScreen> {
  ...
  void updateVocation(Vocation vocation) => setState(() => selectedVocation = vocation);
  ...
  void handleSubmit() {
    if (_nameController.text.trim().isEmpty) {
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          actions: [StyledButton(onPressed: () => Navigator.pop(ctx), child: const StyledHeading('Close'))],
    ...
    Provider.of<CharacterStore>(context, listen: false).addCharacter(Character(name: _nameController.text.trim(), slogan: _sloganController.text.trim(), vocation: selectedVocation, id: uuid.v4()));
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(prefixIcon: Icon(Icons.person_2), label: StyledText('Character name')),
              ...
              TextField(
                ...
                cursorColor: AppColors.textColor,
                decoration: const InputDecoration(prefixIcon: Icon(Icons.chat), label: StyledText('Character slogan')),
                style: GoogleFonts.kanit(textStyle: Theme.of(context).textTheme.bodyMedium),
              ),
              const SizedBox(height: 30),
